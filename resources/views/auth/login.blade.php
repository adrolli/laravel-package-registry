    ...
    <div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div class="bg-white py-8 px-4 shadow sm:rounded-md sm:px-10">
                ...
                <x-tallui.validation-errors class="rounded-md bg-red-50 p-4" />
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <x-tallui.input id="email" name="email" type="email" autocomplete="email" required :value="old('email')" autofocus />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <x-tallui.input id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="current-password" />
                    </div>
                </div>
